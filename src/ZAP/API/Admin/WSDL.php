...
class ZAP_API_Admin_WSDL extends ZAP_API_Admin_Base
{
	...
	{
		return $this->_client->abortHsmRequest();
	}
	...
	public function abortXMbxSearch($searchId, $account)
	{
		...
		return $this->_client->abortXMbxSearchRequest($params);
	}
	...
	public function activateLicense($aid)
	{
		...
		return $this->_client->activateLicenseRequest($params);
	}
	...
	public function addAccountAlias($id, $alias)
	{
		...
		return $this->_client->addAccountAliasRequest($params);
	}
	...
	public function addAccountLogger($account, $category, $level = 'error')
	{
		...
		return $this->_client->addAccountLoggerRequest($params);
	}
	...
	public function addDistributionListAlias($id, $alias)
	{
		...
		return $this->_client->addDistributionListAliasRequest($params);
	}
	...
	public function addDistributionListMember($id, array $members)
	{
		...
		return $this->_client->addDistributionListMemberRequest($params);
	}
	...
	{
		$type = in_array($type, array('both', 'ldap', 'zimbra')) ? $type : 'zimbra';
		$params = array(
			'name' => $name,
			'domain' => $domain,
			'type' => $type,
		...
		if(!empty($folder)) $params['folder'] = $folder;
		...
		return $this->_client->addGalSyncDataSourceRequest($params);
	}
	...
	public function adminCreateWaitSet(array $add, array $types = array(), $all = FALSE)
	{
		...
		return $this->_client->adminCreateWaitSetRequest($params);
	}
	...
	{
		return $this->_client->adminDestroyWaitSetRequest(array('waitSet' => $waitSet));
	}
	...
	public function adminWaitSet($waitSet, $seq, array $add = array(), array $update = array(), array $remove = array(), array $types = array('all'), $block = 0, $timeout = 0)
	{
		...
		$defTypes = $this->_defTypes($types);
		if(!empty($defTypes)) $params['defTypes'] = $defTypes;
		if((int) $block > 0) $params['block'] = 1;
		if((int) $timeout > time()) $params['timeout'] = (int) $timeout;
		...
		return $this->_client->adminWaitSetRequest($params);
	}
	...
	public function autoCompleteGal($domain, $name, $type = 'accounts', $acctID = '')
	{
		...
		if(in_array($type, $types)) $params['type'] = $type;
		if(!empty($acctID)) $params['galAcctId'] = $acctID;

		return $this->_client->autoCompleteGalRequest($params);
	}
	...
	public function autoProvAccount($domain, $principal, $password = '')
	{
		...
		return $this->_client->autoProvAccountRequest($params);
	}
	...
	public function autoProvTaskControl($action)
	{
		...
		return $this->_client->autoProvTaskControlRequest($params);
	}
	...
	public function backup(array $backup, array $file = array(), array $accounts = array('all'))
	{
		...
		return $this->_client->backupRequest($params);
	}
	...
	public function backupAccountQuery(array $query, array $accounts = array('all'))
	{
		...
		return $this->_client->backupAccountQueryRequest($params);
	}
	...
	public function backupQuery(array $query)
	{
		...
		return $this->_client->backupQueryRequest($params);
	}
	...
	public function cancelPendingRemoteWipe($account, $device = '')
	{
		...
		return $this->_client->cancelPendingRemoteWipeRequest($params);
	}
	...
	public function checkAuthConfig($name, $password, array $attrs = array())
	{
		...
		return $this->_client->checkAuthConfigRequest($params);
	}
	...
	public function checkBlobConsistency($checkSize = 0, $report = 1, array $volumes = array(), array $mboxes = array())
	{
		...
		return $this->_client->checkBlobConsistencyRequest($params);
	}
	...
	public function checkDirectory(array $directories = array())
	{
		...
		return $this->_client->checkDirectoryRequest($params);
	}
	...
	public function checkDomainMXRecord($domain)
	{
		...
		return $this->_client->checkDomainMXRecordRequest($params);
	}
	...
	public function checkExchangeAuth($url, $user, $pass, $scheme = 'basic')
	{
		...
		return $this->_client->checkExchangeAuthRequest($params);
	}
	...
	public function checkGalConfig($query, $action = 'search', $limit = 10, array $attrs = array())
	{
		...
		return $this->_client->checkGalConfigRequest($params);
	}
	...
	{
		return $this->_client->checkHealthRequest();
	}
	...
	{
		$params = array();
		if(!empty($hostname)) $params['hostname'] = $hostname;
		return $this->_client->checkHostnameResolveRequest($params);
	}
	...
	public function checkPasswordStrength($id, $password)
	{
		...
		return $this->_client->checkPasswordStrength($params);
	}
	...
	public function checkRights($right, $target, $type, array $grantee, array $attrs = array())
	{
		...
		return $this->_client->checkRightRequest($params);
	}
	...
	public function clearCookie(array $cookies = array())
	{
		...
		return $this->_client->clearCookieRequest($params);
	}
	...
	public function compactIndex($id, $action = 'status')
	{
		...
		return $this->_client->compactIndexRequest($params);
	}
	...
	{
		return $this->_client->computeAggregateQuotaUsageRequest();
	}
	...
	public function configureZimlet($aid)
	{
		...
		return $this->_client->configureZimletRequest($params);
	}
	...
	public function copyCos($name, $cos)
	{
		...
		return $this->_client->copyCosRequest($params);
	}
	...
	public function countAccount($domain = '')
	{
		...
		return $this->_client->countAccountRequest($params);
	}
	...
	public function countObjects($type = 'account', $domain = '', $ucservice = '')
	{
		...
		return $this->_client->countObjectsRequest($params);
	}
	...
	public function createAccount($name, $password, array $attrs = array())
	{
		...
		return $this->_client->createAccountRequest($params);
	}
	...
	public function createArchive($account, $name = '', $cos = '', $password = '', array $attrs = array())
	{
		...
		return $this->_client->createArchiveRequest($params);
	}
	...
	public function createCalendarResource($name, $password = '', array $attrs = array())
	{
		...
		return $this->_client->createCalendarResourceRequest($params);
	}
	...
	public function createCos($name, array $attrs = array())
	{
		...
		return $this->_client->createCosRequest($params);
	}
	...
	public function createDataSource($id, $type, $name, array $attrs = array())
	{
		...
		return $this->_client->createDataSourceRequest($params);
	}
	...
	public function createDistributionList($name, array $attrs = array(), $dynamic = FALSE)
	{
		...
		return $this->_client->createDistributionListRequest($params);
	}
	...
	public function createDomain($name, array $attrs = array())
	{
		...
		return $this->_client->createDomainRequest($params);
	}
	...
	public function createGalSyncAccount($name, $domain, $server, $account, $type = 'both', $password = '', $folder = '', array $attrs = array())
	{
		...
		return $this->_client->createGalSyncAccountRequest($params);
	}
	...
	public function createLDAPEntry($dn, array $attrs = array())
	{
		...
		return $this->_client->createLDAPEntryRequest($params);
	}
	...
	public function createServer($name, array $attrs = array())
	{
		...
		return $this->_client->createServerRequest($params);
	}
	...
	public function createSystemRetentionPolicy($cos = '', array $keep = array(), array $purge = array())
	{
		...
		return $this->_client->createSystemRetentionPolicyRequest($params);
	}
	...
	public function createUCService($name, array $attrs = array())
	{
		...
		return $this->_client->createUCServiceRequest($params);
	}
	...
	public function createVolume(array $volume)
	{
		...
		return $this->_client->createVolumeRequest($params);
	}
	...
	public function createXMPPComponent($name, $domain, $server, array $attrs = array())
	{
		...
		return $this->_client->createXMPPComponentRequest($params);
	}
	...
	public function createXMbxSearch(array $attrs = array())
	{
		...
		return $this->_client->createXMbxSearchRequest($params);
	}
	...
	public function createZimlet($name, array $attrs = array())
	{
		...
		return $this->_client->createZimletRequest($params);
	}
	...
	public function dedupeBlobs($action, array $volumes = array())
	{
		...
		return $this->_client->dedupeBlobsRequest($params);
	}
	...
	public function delegateAuth($account, $duration = 3600)
	{
		...
		return $this->_client->delegateAuthRequest($params);
	}
	...
	{
		return $this->_client->deleteAccountRequest(array('id' => $id));
	}
	...
	{
		return $this->_client->deleteCalendarResourceRequest(array('id' => $id));
	}
	...
	{
		return $this->_client->deleteCosRequest(array('id' => $id));
	}
	...
	public function deleteDataSource($id, $dataSource, array $attrs = array())
	{
		...
		return $this->_client->deleteDataSourceRequest($params);
	}
	...
	{
		return $this->_client->deleteDistributionListRequest(array('id' => $id));
	}
	...
	{
		return $this->_client->deleteDomainRequest(array('id' => $id));
	}
	...
	public function deleteGalSyncAccount($account)
	{
		...
		return $this->_client->deleteGalSyncAccountRequest($params);
	}
	...
	{
		return $this->_client->deleteLDAPEntryRequest(array('dn' => $dn));
	}
	...
	public function deleteMailbox($id)
	{
		...
		return $this->_client->deleteMailboxRequest($params);
	}
	...
	{
		return $this->_client->deleteServerRequest(array('id' => $id));
	}
	...
	public function deleteSystemRetentionPolicy(array $policy, $cos = '')
	{
		...
		return $this->_client->deleteSystemRetentionPolicyRequest($param);
	}
	...
	{
		return $this->_client->deleteUCServiceRequest(array('id' => $id));
	}
	...
	{
		return $this->_client->deleteVolumeRequest(array('id' => $id));
	}
	...
	public function deleteXMPPComponent($xmpp)
	{
		...
		return $this->_client->deleteXMPPComponentRequest($params);
	}
	...
	public function deleteXMbxSearch($searchId, $account = '')
	{
		...
		return $this->_client->deleteXMbxSearchRequest($params);
	}
	...
	public function deleteZimlet($name)
	{
		...
		return $this->_client->deleteZimletRequest($params);
	}
	...
	public function deployZimlet($action, $aid, $flush = FALSE, $sync = FALSE)
	{
		...
		return $this->_client->deployZimletRequest($params);
	}
	...
	public function disableArchive($account)
	{
		...
		return $this->_client->disableArchiveRequest($params);
	}
	...
	public function dumpSessions($list = TRUE, $groupBy = FALSE)
	{
		...
		return $this->_client->dumpSessionsRequest($params);
	}
	...
	public function enableArchive($account, $name, $create = FALSE, $cos = '', $password = '', array $attrs = array())
	{
		...
		return $this->_client->enableArchiveRequest($params);
	}
	...
	public function exportAndDeleteItems($id, $dir, $prefix = '', array $items = array())
	{
		...
		return $this->_client->exportAndDeleteItemsRequest($params);
	}
	...
	public function exportMailbox($account, $dest, $port = 0, $tempDir = '', $overwrite = FALSE)
	{
		...
		return $this->_client->exportMailboxRequest($params);
	}
	...
	public function failoverClusterService($name, $newServer)
	{
		...
		return $this->_client->failoverClusterServiceRequest($params);
	}
	...
	public function fixCalendarEndTime($account, $sync = FALSE)
	{
		...
		return $this->_client->fixCalendarEndTimeRequest($params);
	}
	...
	public function fixCalendarPriority($account, $sync = FALSE)
	{
		...
		return $this->_client->fixCalendarPriorityRequest($params);
	}
	...
	public function fixCalendarTZ($account, array $tzfixup, $sync = FALSE, $after = 0)
	{
		...
		return $this->_client->fixCalendarTZRequest($params);
	}
	...
	public function flushCache(array $types = array('account'), array $entries = array(), $all = FALSE)
	{
		...
		return $this->_client->flushCacheRequest($params);
	}
	...
	public function genCSR($server, $new, $keysize = 1024, $type = 'self', array $attrs = array(), array $altNames  = array())
	{
		...
		return $this->_client->genCSRRequest($params);
	}
	...
	public function getAccount($account, array $attrs = array(), $applyCos = TRUE)
	{
		...
		if(!empty($attrsStr))
		{
			$params['attrs'] = $attrsStr;
		}
		return $this->_client->getAccountRequest($params);
	}
	...
	public function getAccountInfo($account)
	{
		...
		return $this->_client->getAccountInfoRequest($params);
	}
	...
	public function getAccountLoggers($account)
	{
		...
		return $this->_client->getAccountLoggersRequest($params);
	}
	...
	public function getAccountMembership($account)
	{
		...
		return $this->_client->getAccountMembershipRequest($params);
	}
	...
	public function getAdminConsoleUIComp($account, $dl = '')
	{
		...
		return $this->_client->getAdminConsoleUICompRequest($params);
	}
	...
	{
		return $this->_client->getAdminExtensionZimletsRequest();
	}
	...
	public function getAdminSavedSearches($name)
	{
		...
		return $this->_client->getAdminSavedSearchesRequest($params);
	}
	...
	{
		return $this->_client->getAggregateQuotaUsageOnServerRequest($params);
	}
	...
	{
		return $this->_client->getAllAccountLoggersRequest($params);
	}
	...
	public function getAllAccounts($server = '', $domain = '')
	{
		...
		return $this->_client->getAllAccountsRequest($params);
	}
	...
	public function getAllAdminAccounts($applyCos = TRUE)
	{
		...
		return $this->_client->getAllAdminAccountsRequest($params);
	}
	...
	public function getAllCalendarResources($server = '', $domain = '')
	{
		...
		return $this->_client->getAllCalendarResourcesRequest($params);
	}
	...
	{
		return $this->_client->getAllConfigRequest($params);
	}
	...
	{
		return $this->_client->getAllCosRequest();
	}
	...
	public function getAllDistributionLists($domain = '')
	{
		...
		return $this->_client->getAllDistributionListsRequest($params);
	}
	...
	{
		$params['applyCos'] = (bool) $applyCos ? 1 : 0;
		return $this->_client->getAllDomainsRequest($params);
	}
	...
	{
		$params = array();
		if(!empty($expand)) $params['expandAllAttrs'] = $expand;
		if(!empty($grantee))
		{
		...
		return $this->_client->getAllEffectiveRightsRequest($params);
	}
	...
	{
		return $this->_client->getAllFreeBusyProvidersRequest();
	}
	...
	{
		return $this->_client->getAllLocalesRequest();
	}
	...
	public function getAllMailboxes($limit = 0, $offset = 0)
	{
		...
		return $this->_client->getAllMailboxesRequest($params);
	}
	...
	public function getAllServers($service = 'mailbox', $apply = FALSE)
	{
		...
		return $this->_client->getAllServersRequest($params);
	}
	...
	{
		return $this->_client->getAllSkinsReques();
	}
	...
	{
		return $this->_client->getAllUCProvidersRequest();
	}
	...
	{
		return $this->_client->getAllUCServicesRequest();
	}
	...
	{
		return $this->_client->getAllVolumesRequest();
	}
	...
	{
		return $this->_client->getAllXMPPComponentsRequest();
	}
	...
	public function getAllZimlets($exclude = 'none')
	{
		...
		return $this->_client->getAllZimletsRequest(array('exclude' => $exclude));
	}
	...
	{
		return $this->_client->getApplianceHSMFSRequest();
	}
	...
	public function getAttributeInfo(array $attrs = array(), array $entryTypes = array())
	{
		$params = array();
		$attrsStr = $this->_commaAttributes($attrs);
		if(!empty($attrsStr)) $params['attrs'] = $attrsStr;
		...
		if(!empty($entryTypesStr)) $params['entryTypes'] = $entryTypesStr;
		return $this->_client->getAttributeInfoRequest($params);
	}
	...
	public function getCSR($server = '--- All Servers ---', $type = 'self')
	{
		...
		return $this->_client->getCSRRequest($params);
	}
	...
	public function getCalendarResource($account = '', $applyCos = TRUE, array $attrs = array())
	{
		...
		return $this->_client->getCalendarResourceRequest($params);
	}
	...
	public function getCert($server, $type = 'all', $option = 'self')
	{
		...
		return $this->_client->getCertRequest($params);
	}
	...
	{
		return $this->_client->getClusterStatus();
	}
	...
	public function getConfig(array $attrs = array())
	{
		...
		return $this->_client->getConfigRequest($params);
	}
	...
	public function getCos($cos = '', array $attrs = array())
	{
		...
		return $this->_client->getCosRequest($params);
	}
	...
	public function getCreateObjectAttrs($type, $target = '', $domain = '', $cos = '')
	{
		...
		return $this->_client->getCreateObjectAttrsRequest($params);
	}
	...
	{
		return $this->_client->getCurrentVolumesRequest();
	}
	/**
	...
	public function getDataSources($id, array $attrs = array())
	{
		...
		return $this->_client->getDataSourcesRequest($params);
	}
	...
	public function getDelegatedAdminConstraints($type, $name = '', $id = '', array $attrs = array())
	{
		...
		return $this->_client->getDelegatedAdminConstraintsRequest($params);
	}
	...
	public function getDeviceStatus($account, $device = '')
	{
		...
		return $this->_client->getDeviceStatusRequest($params);
	}
	...
	public function getDevices($account)
	{
		...
		return $this->_client->getDevicesRequest($params);
	}
	...
	{
		return $this->_client->getDevicesCountRequest();
	}
	...
	public function getDevicesCountSinceLastUsed($date)
	{
		...
		return $this->_client->getDevicesCountSinceLastUsedRequest($params);
	}
	...
	{
		return $this->_client->getDevicesCountUsedTodayRequest();
	}
	...
	public function getDistributionList($dl = '', array $attrs = array(), $limit = 0, $offset = 0, $asc = TRUE)
	{
		...
		return $this->_client->getDistributionListRequest($params);
	}
	...
	public function getDistributionListMembership($dl = '', $limit = 0, $offset = 0)
	{
		...
		return $this->_client->getDistributionListMembershipRequest($params);
	}
	...
	public function getDomain($domain = '', $apply = TRUE, array $attrs = array())
	{
		...
		return $this->_client->getDomainRequest($params);
	}
	...
	public function getDomainInfo($domain = '', $apply = TRUE)
	{
		...
		return $this->_client->getDomainInfoRequest($params);
	}
	...
	public function getEffectiveRights($target, $type, array $grantee = array(), $expand = 'getAttrs,setAttrs')
	{
		...
		return $this->_client->getEffectiveRightsRequest($params);
	}
	...
	public function getFreeBusyQueueInfo($name)
	{
		...
		return $this->_client->getFreeBusyQueueInfoRequest($params);
	}
	...
	public function getGrants($target, $type, array $grantee = array())
	{
		...
		return $this->_client->getGrantsRequest($params);
	}
	...
	{
		return $this->_client->getHsmStatusRequest();
	}
	...
	public function getIndexStats($id)
	{
		...
		return $this->_client->getIndexStatsRequest($params);
	}
	...
	public function getLDAPEntries($query, $base, $limit = 0, $offset = 0, $sort = NULL, $asc = TRUE)
	{
		...
		return $this->_client->getLDAPEntriesRequest($params);
	}
	...
	{
		return $this->_client->getLicenseRequest();
	}
	...
	{
		return $this->_client->getLicenseInfoRequest();
	}
	...
	public function getLoggerStats($hostname, $startTime, $endTime, array $stats = array())
	{
		...
		return $this->_client->getLoggerStatsRequest($params);
	}
	...
	public function getMailQueue($server, $queue, array $field = array(), $scan = TRUE, $wait = 3, $limit = 0, $offset = 0)
	{
		...
		return $this->_client->getMailQueueRequest($params);
	}
	...
	public function getMailQueueInfo($server)
	{
		...
		return $this->_client->getMailQueueInfoRequest($params);
	}
	...
	public function getMailbox($id)
	{
		...
		return $this->_client->getMailboxRequest($params);
	}
	...
	{
		return $this->_client->getMailboxStatsRequest();
	}
	...
	public function getMailboxVersion($account)
	{
		...
		return $this->_client->getMailboxVersionRequest($params);
	}
	...
	public function getMailboxVolumes($account)
	{
		...
		return $this->_client->getMailboxVolumesRequest($params);
	}
	...
	{
		return $this->_client->getMemcachedClientConfigRequest();
	}
	...
	public function getQuotaUsage($domain = '', $all = TRUE, $limit = 0, $offset = 0, $sort = 'percentUsed', $asc = FALSE, $refresh = FALSE)
	{
		...
		return $this->_client->getQuotaUsageRequest($params);
	}
	...
	public function getRight($right, $expand = FALSE)
	{
		...
		return $this->_client->getRightRequest($params);
	}
	...
	public function getRightsDoc(array $packages = array())
	{
		...
		return $this->_client->getRightsDocRequest($params);
	}
	...
	public function getSMIMEConfig($name = '', $domain = '')
	{
		...
		return $this->_client->getSMIMEConfigRequest($params);
	}
	...
	public function getServer($server, array $attrs = array(), $apply = TRUE)
	{
		...
		return $this->_client->getServerRequest($params);
	}
	...
	public function getServerNIfs($server, $type = 'ipV4')
	{
		...
		return $this->_client->getServerNIfsRequest($params);
	}
	...
	public function getServerStats(array $stats = array())
	{
		...
		return $this->_client->getServerStatsRequest($params);
	}
	...
	{
		return $this->_client->getServiceStatusRequest();
	}
	...
	public function getSessions($type, $sortBy = 'nameAsc', $limit = 0, $offset = 0, $refresh = TRUE)
	{
		...
		return $this->_client->getSessionsRequest($params);
	}
	...
	public function getShareInfo($owner, $type = '', $name = '', $id = '')
	{
		...
		return $this->_client->getShareInfoRequest($params);
	}
	...
	public function getSystemRetentionPolicy($cos = '')
	{
		...
		return $this->_client->getSystemRetentionPolicyRequest($params);
	}
	...
	public function getUCService($ucservice = '', array $attrs = array())
	{
		...
		return $this->_client->getUCServiceRequest($params);
	}
	...
	{
		return $this->_client->getVersionInfoRequest();
	}
	...
	{
		return $this->_client->getVolumeRequest(array('id' => (int) $id));
	}
	...
	public function getXMPPComponent($xmpp, array $attrs = array())
	{
		...
		return $this->_client->getXMPPComponentRequest($params);
	}
	...
	{
		return $this->_client->getXMbxSearchesListRequest();
	}
	...
	public function getZimlet($name, array $attrs = array())
	{
		...
		return $this->_client->getZimletRequest($params);
	}
	...
	{
		return $this->_client->getZimletStatusRequest();
	}
	...
	public function grantRight($target, $type, array $grantee, array $right)
	{
		...
		return $this->_client->grantRightRequest($params);
	}
	...
	public function hsm()
	{
		return $this->_client->hsmRequest();
	}
	...
	public function installCert($server, $type = 'self', array $comm_cert = array(), array $subject = array(), $validDays = 0, array $subjectAltNames = array(), $keysize = 1024)
	{
		...
		return $this->_client->installCertRequest($params);
	}
	...
	public function installLicense($aid)
	{
		...
		return $this->_client->installLicenseRequest($params);
	}
	...
	public function mailQueueAction($server, $queue, $op, $by, array $query = array(), array $field = array())
	{
		...
		return $this->_client->mailQueueActionRequest($params);
	}
	...
	public function mailQueueFlush($server)
	{
		...
		return $this->_client->mailQueueFlushRequest($params);
	}
	...
	public function migrateAccount($id, $action)
	{
		...
		return $this->_client->migrateAccountRequest($params);
	}
	...
	public function modifyAccount($id, array $attrs = array())
	{
		...
		$attributes = $this->_attributes($attrs);
		if(count($attributes)) $params['a'] = $attributes;
		return $this->_client->modifyAccountRequest($params);
	}
	...
	public function modifyAdminSavedSearches(array $searchs = array())
	{
		...
		return $this->_client->modifyAdminSavedSearchesRequest($params);
	}
	...
	public function modifyCalendarResource($id, array $attrs = array())
	{
		...
		$attributes = $this->_attributes($attrs);
		if(count($attributes)) $params['a'] = $attributes;
		return $this->_client->modifyCalendarResourceRequest($params);
	}
	...
	public function modifyConfig(array $attrs = array())
	{
		...
		$attributes = $this->_attributes($attrs);
		if(count($attributes)) $params['a'] = $attributes;
		return $this->_client->modifyConfigRequest($params);
	}
	...
	public function modifyCos($id, array $attrs = array())
	{
		...
		$attributes = $this->_attributes($attrs);
		if(count($attributes)) $params['a'] = $attributes;
		return $this->_client->modifyCosRequest($params);
	}
	...
	public function modifyDataSource($id, $dataSource, array $attrs = array())
	{
		$params = array(
			'id' => $id,
			'dataSource' => array('id' => $dataSource),
		);
		$attributes = $this->_attributes($attrs);
		if(count($attributes)) $params['a'] = $attributes;
		return $this->_client->modifyDataSourceRequest($params);
	}
	...
	public function modifyDelegatedAdminConstraints($type, $id = '', $name = '', array $attrs = array())
	{
		...
		return $this->_client->modifyDelegatedAdminConstraintsRequest($params);
	}
	...
	public function modifyDistributionList($id, array $attrs = array())
	{
		...
		$attributes = $this->_attributes($attrs);
		if(count($attributes)) $params['a'] = $attributes;
		return $this->_client->modifyDistributionListRequest($params);
	}
	...
	public function modifyDomain($id, array $attrs = array())
	{
		...
		$attributes = $this->_attributes($attrs);
		if(count($attributes)) $params['a'] = $attributes;
		return $this->_client->modifyDomainRequest($params);
	}
	...
	public function modifyLDAPEntry($dn, array $attrs = array())
	{
		...
		$attributes = $this->_attributes($attrs);
		if(count($attributes)) $params['a'] = $attributes;
		return $this->_client->modifyLDAPEntryRequest($params);
	}
	...
	public function modifySMIMEConfig($name, $op = 'modify', array $attrs = array(), $domain = '')
	{
		...
		return $this->_client->modifySMIMEConfigRequest($params);
	}
	...
	public function modifyServer($id, array $attrs = array())
	{
		...
		$attributes = $this->_attributes($attrs);
		if(count($attributes)) $params['a'] = $attributes;
		return $this->_client->modifyServerRequest($params);
	}
	...
	public function modifySystemRetentionPolicy(array $policy, $cos = '' )
	{
		...
		return $this->_client->modifySystemRetentionPolicyRequest($params);
	}
	...
	public function modifyUCService($id, array $attrs = array())
	{
		...
		$attributes = $this->_attributes($attrs);
		if(count($attributes)) $params['a'] = $attributes;
		return $this->_client->modifyUCServiceRequest('', $params);
	}
	...
	public function modifyVolume($id, array $volume = array())
	{
		...
		return $this->_client->modifyVolumeRequest($params);
	}
	...
	public function modifyZimlet($name, $cos = '', $acl = 'grant', $status = 'enabled', $priority = 0)
	{
		...
		return $this->_client->modifyZimletRequest($params);
	}
	...
	public function moveBlobs(array $types, array $sources, $dest, $maxBytes = 0, $query = '')
	{
		...
		if((int) $maxBytes > 0) $params['maxBytes'] = (int) $maxBytes;
		$params = array();
		if(!empty($query)) $params['query'] = $query;

		return $this->_client->moveBlobsRequest($params);
	}
	...
	public function moveMailbox($name, $dest, $src, $blobs = 'config', $secondBlobs = 'config', $searchIndex = 'config', $maxSyncs = 10, $threshold = 30000, $sync = FALSE)
	{
		...
		return $this->_client->moveMailboxRequest($params);
	...
	{
		return $this->_client->noOpRequest();
	}
	...
	{
		return $this->_client->pingRequest();
	}
	...
	{
		return $this->_client->purgeAccountCalendarCacheRequest(array('id' => $id));
	}
	...
	public function purgeFreeBusyQueue($name)
	{
		...
		return $this->_client->purgeFreeBusyQueueRequest($params);
	}
	...
	public function purgeMessages($id)
	{
		...
		return $this->_client->purgeMessagesRequest($params);
	}
	...
	public function purgeMovedMailbox($name)
	{
		...
		return $this->_client->purgeMovedMailboxRequest($params);
	}
	...
	public function pushFreeBusy(array $domains = array(), $account = '')
	{
		...
		return $this->_client->pushFreeBusyRequest($params);
	}
	...
	{
		$params = array('checkPeer' => ((bool) $checkPeer) ? 1 : 0);
		if(count($accounts))
		{
			$params['account'] = array();
			foreach ($accounts as $account)
		...
		return $this->_client->queryMailboxMoveRequest($params);
	}
	...
	{
		return $this->_client->queryWaitSetRequest(array('waitSet' => $waitSet));
	}
	...
	public function reIndex($id, $action = 'status', array $types = array(), array $ids = array())
	{
		...
		return $this->_client->reIndexRequest($params);
	}
	...
	public function recalculateMailboxCounts($id)
	{
		...
		return $this->_client->recalculateMailboxCountsRequest($params);
	}
	...
	public function registerMailboxMoveOut($name, $dest)
	{
		...
		return $this->_client->registerMailboxMoveOutRequest($params);
	}
	...
	public function reloadAccount($name)
	{
		...
		return $this->_client->reloadAccountRequest($params);
	}
	...
	{
		return $this->_client->reloadLocalConfigRequest();
	}
	...
	{
		return $this->_client->reloadMemcachedClientConfigRequest();
	}
	...
	public function remoteWipe($account, $deviceId = '')
	{
		...
		return $this->_client->remoteWipeRequest($params);
	}
	...
	public function removeAccountAlias($alias, $id = '')
	{
		...
		if(!empty($id)) $params['id'] = $id;
		return $this->_client->removeAccountAliasRequest($params);
	}
	...
	public function removeAccountLogger($account, $category = '', $level = '')
	{
		...
		return $this->_client->removeAccountLoggerRequest($params);
	}
	...
	public function removeDevice($account, $deviceId = '')
	{
		...
		return $this->_client->removeDeviceRequest($params);
	}
	...
	public function removeDistributionListAlias($id, $alias)
	{
		...
		return $this->_client->removeDistributionListAliasRequest($params);
	}
	...
	public function removeDistributionListMember($id, array $dlm)
	{
		...
		return $this->_client->removeDistributionListMemberRequest($params);
	}
	...
	public function renameAccount($id, $newName)
	{
		...
		return $this->_client->renameAccountRequest($params);
	}
	...
	public function renameCalendarResource($id, $newName)
	{
		...
		return $this->_client->renameCalendarResourceRequest($params);
	}
	...
	public function renameCos($id, $newName)
	{
		...
		return $this->_client->renameCosRequest($params);
	}
	...
	public function renameDistributionList($id, $newName)
	{
		...
		return $this->_client->renameDistributionListRequest($params);
	}
	...
	public function renameLDAPEntry($dn, $newDn)
	{
		...
		return $this->_client->renameLDAPEntryRequest($params);
	}
	...
	public function renameUCService($id, $newName)
	{
		...
		return $this->_client->renameUCServiceRequest($params);
	}
	...
	{
		return $this->_client->resetAllLoggersRequest();
	}
	...
	public function restore(array $restore, array $file = array(), array $accounts = array('all'))
	{
		...
		return $this->_client->restoreRequest($params);
	}
	...
	public function resumeDevice($account, $device = '')
	{
		...
		return $this->_client->resumeDeviceRequest($params);
	}
	...
	public function revokeRight($target, $type, array $grantee, array $right)
	{
		...
		return $this->_client->revokeRightRequest($params);
	}
	...
	{
		return $this->_client->rolloverRedoLogRequest();
	}
	...
	public function runUnitTests(array $tests = array())
	{
		...
		return $this->_client->runUnitTestsRequest($params);
	}
	...
	public function scheduleBackups($server)
	{
		...
		return $this->_client->scheduleBackupsRequest($params);
	}
	...
	public function searchAccounts($query, $domain = '', $apply = TRUE, array $types = array('accounts'), array $attrs = array(), $sortBy = '', $asc = TRUE, $limit = 0, $offset = 0)
	{
		...
		if(!empty($typesStr)) $params['types'] = $typesStr;
		$attrsStr = $this->_commaAttributes($attrs);
		if(!empty($attrsStr)) $params['attrs'] = $attrsStr;
		return $this->_client->searchAccountsRequest($params);
	}
	...
	public function searchAutoProvDirectory($key, $domain, $query = '', $name = '', $max = 0, $refresh = FALSE, array $attrs = array(), $limit = 0, $offset = 0)
	{
		...
		$attrsStr = $this->_commaAttributes($attrs);
		if(!empty($attrsStr)) $params['attrs'] = $attrsStr;
		return $this->_client->searchAutoProvDirectoryRequest($params);
	}
	...
	public function searchCalendarResources(array $conds = array(), $domain = '', $apply = TRUE, array $attrs = array(), $sort = '', $asc = TRUE, $limit = 0, $offset = 0)
	{
		...
		if(!empty($domain)) $params['domain'] = $domain;
		if(!empty($sort)) $params['sortBy'] = $sort;
		$attrsStr = $this->_commaAttributes($attrs);
		if(!empty($attrsStr)) $params['attrs'] = $attrsStr;
		...
		return $this->_client->searchCalendarResourcesRequest($params);
	}
	...
	public function searchDirectory($query = '', $domain = '', $applyCos = TRUE, $applyConfig = TRUE, $countOnly = FALSE, array $attrs = array(), array $types = array('accounts'), $max = 0, $sort = '', $asc = TRUE, $limit = 0, $offset = 0)
	{
		...
		return $this->_client->searchDirectoryRequest($params);
	}
	...
	public function searchGal($domain, $type = 'account', $name = '', $galAcctId = '', $limit = 0)
	{
		...
		if(!empty($name)) $params['name'] = $name;
		if(!empty($galAcctId)) $params['galAcctId'] = $galAcctId;
		if(!empty($sort)) $params['sortBy'] = $sort;

		return $this->_client->searchGalRequest($params);
	}
	...
	public function setCurrentVolume($id, $type)
	{
		...
		return $this->_client->setCurrentVolumeRequest($params);
	}
	...
	public function setPassword($id, $password)
	{
		...
		return $this->_client->setPasswordRequest($params);
	}
	...
	public function syncGalAccount(array $galAccounts = array())
	{
		...
		return $this->_client->syncGalAccountRequest($params);
	}
	...
	public function undeployZimlet($name, $action = '')
	{
		...
		return $this->_client->undeployZimletRequest($params);
	}
	...
	public function unloadMailbox($account)
	{
		...
		return $this->_client->unloadMailboxRequest($params);
	}
	...
	public function unregisterMailboxMoveOut($account, $dest)
	{
		...
		return $this->_client->unregisterMailboxMoveOutRequest($params);
	}
	...
	public function updateDeviceStatus($account, $device, $status = 'enabled')
	{
		...
		return $this->_client->updateDeviceStatusRequest($params);
	}
	...
	public function updatePresenceSessionId($ucservice, $username, $password, array $attrs = array())
	{
		...
		$attributes = $this->_attributes($attrs);
		if(count($attributes)) $params['a'] = $attributes;
		return $this->_client->updatePresenceSessionIdRequest($params);
	}
	...
	public function uploadDomCert($certAid, $certFilename, $keyAid, $keyFilename)
	{
		...
		return $this->_client->uploadDomCertRequest($params);
	}
	...
	public function uploadProxyCA($aid, $filename)
	{
		...
		return $this->_client->uploadProxyCARequest($params);
	}
	...
	public function verifyCertKey($cert = '', $privkey = '')
	{
		...
		return $this->_client->verifyCertKeyRequest($params);
	}
	...
	public function verifyIndex($id)
	{
		...
		return $this->_client->verifyIndexRequest($params);
	}
	...
	public function verifyStoreManager($fileSize = 0, $num = 0, $checkBlobs = FALSE)
	{
		...
		return $this->_client->verifyStoreManagerRequest($params);
	}
	...
	public function versionCheck($action = 'check')
	{
		...
		return $this->_client->versionCheckRequest($params);
	}
}