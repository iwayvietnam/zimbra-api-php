...
/**
 * ZAP_API_Mail_WSDL is a class which allows to connect Zimbra API mail functions via SOAP extension
 * @package   ZAP
 * @category  Mail
 * @author    Nguyen Van Nguyen - nguyennv1981@gmail.com
 * @copyright Copyright © 2013 by iWay Vietnam. (http://www.iwayvietnam.com)
 */
class ZAP_API_Mail_WSDL extends ZAP_API_Mail_Base
{
	/**
	 * ZAP_API_Mail_WSDL constructor
	 *
